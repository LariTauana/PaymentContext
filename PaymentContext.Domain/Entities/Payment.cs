...
namespace PaymentContext.Domain.Entities
{
    public abstract class Payment      //Abstract pois não posso estanciar um pagamento direto, ele tem que ser um boleto, CreditCard ou PayPal 
    {
        ...
        public string Address { get; private set; }    //Endereço de cobrança(para emissão de notas). Nesse caso, se esse endereço pode ser diferente do de entrega(está em Student)
